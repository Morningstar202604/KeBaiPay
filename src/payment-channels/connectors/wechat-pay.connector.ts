 ...
 * 微信支付 Connector 适配器
 *
 * 通过适配器模式将 WechatPayChannel 包装为标准 Connector 接口。
 * 所有业务逻辑委托给 WechatPayChannel 实现。
 */
@Injectable()
export class WechatPayConnector implements Connector {
  ...
  private readonly logger = new Logger(WechatPayConnector.name)
  ...
  constructor(private readonly channel: WechatPayChannel) {}
