...
export const KBErrorCodes = {
  ...
  CALLBACK_AMOUNT_MISMATCH: 'KB706',
  LOCK_ACQUISITION_FAILED: 'KB707',
  CALLBACK_TO_USER_MISSING: 'KB708',
...
export const KBErrorMessages: Record<KBErrorCode, string> = {
  ...
  [KBErrorCodes.CALLBACK_AMOUNT_MISMATCH]: '回调金额与订单金额不一致，拒绝入账',
  [KBErrorCodes.CALLBACK_TO_USER_MISSING]: '订单无归属用户，拒绝入账',
  [KBErrorCodes.LOCK_ACQUISITION_FAILED]: '操作冲突，请稍后重试',
